...
class AFNONet(nn.Module):
    def __init__(
        ...
        h_remainder = img_size[0] % patch_size[0]
        h_pad = patch_size[0] - h_remainder
        padding_top = h_pad // 2
        ...
        if img_size[0] % patch_size[0] != 0:
            pad_size = patch_size[0] - img_size[0] % patch_size[0]
    ...
    def forward(self, x, hour_of_year):
        ...
        return x[:, :, self.padding_top:-self.padding_bottom, :]
