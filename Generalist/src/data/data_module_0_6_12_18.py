...
from src.data.components.iterative_dataset_0_6_12_18 import MultiStepRandomizedDataset, MultiLeadtimeDataset
...
def collate_fn_train(
    ...
    return inp, out, hour_of_year, lead_times, exist_cmpa, variables
...
def collate_fn_val(
    ...
    return inp, out, hour_of_year, exist_cmpa, variables
