...
class ModelInterface(LightningModule):
    ...
    def training_step(self, batch: Any, batch_idx: int):
        ...
        direct_loss = self.MSELoss(norm_preds, targets, exist_cmpa)  # CMPA only
        self.log(
            "train/direct_loss",
            direct_loss,
            on_step=False,
        ...
        autoreg_loss = self.MSELoss(assist_preds, target_assist, assists_exist_cmpa)
        self.log(
            "train/autoreg_loss",
            autoreg_loss,
            on_step=False,
    ...
    def evaluate(
        ...
        for target_lead_time in val_lead_times:
            ...
            direct_loss = self.MSELoss(norm_pred, targets, exist_cmpa)  # CMPA only
            # autoreg_loss = self.CorLoss(assist_pred, target_assist,  assists_exist_cmpa)
