...
class ModelInterface(LightningModule):
    ...
    def training_step(self, batch: Any, batch_idx: int):
        ...
        fourier_loss = self.fourier_loss(norm_preds, targets, exist_cmpa)  # CMPA only
        self.log(
            "train/cmpa_fourier_loss",
            fourier_loss,
            on_step=False,
            on_epoch=True,
            prog_bar=True,
        ...
        PhyAst_fourier_loss = self.PhyAst_fourier_loss(assist_preds, target_assist, assists_exist_cmpa)
        self.log(
            "train/PhyAst_fourier_loss",
            PhyAst_fourier_loss,
            on_step=False,
            on_epoch=True,
            prog_bar=True,
        ...
        return fourier_loss + PhyAst_fourier_loss 
